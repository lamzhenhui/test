/**
 * Description: ABA问题的解决 * * @author veliger@163.com * @date 2019-04-12 21:30
 **/
...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        new Thread(() -> {
            System.out.println(atomicReference+"加前");
            System.out.println(atomicReference.compareAndSet(100, 101));
            System.out.println(atomicReference+"加了");

//            atomicReference.compareAndSet(101, 100);
        }, "t1").start();
        System.out.println(atomicReference+"加后");
